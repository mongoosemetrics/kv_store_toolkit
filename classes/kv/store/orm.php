...
abstract class KV_Store_ORM {
     ...
     *              to be stored as separate key/value pairs in the KV store
    ...
    /**
     * Returns the KV store key name for the passed alternate
     ...
     * @return  string  The KV store key name.
     */
    protected function _get_alternate_key_name($name, $value)
    {
        // Return the KV store key name
